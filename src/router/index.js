...
const router = new Router({
  ...
  },
  {
    ...
    },
    {
      ...
      name: 'bumen',
      component: resolve =>
        require(['../views/bumen/bumen.vue'], resolve),
      meta: { requiresAuth: true }
    },
    {
      path: '/chakan',
      name: 'chakan',
      component: resolve =>
        require(['../views/chakan/chakan.vue'], resolve),
      meta: { requiresAuth: true }
    },
    {
      path: '/visit',
      name: 'visit',
      component: resolve =>
        require(['../views/visit/visit.vue'], resolve),
      meta: { requiresAuth: true }
    },
    {
      path: '/see_visit',
      name: 'see_visit',
      component: resolve =>
        require(['../views/see_visit/see_visit.vue'], resolve),
      meta: { requiresAuth: true }
    },
    ]
