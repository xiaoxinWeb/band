  ...
  <div>
    ...
    >
      <el-form-item label="银行ID" prop="selectList2">
        ...
        <el-select
          v-model="bankaddData.selectList1"
          placeholder="请选择"
          prop="selectList"
          @change="select"
        >
          <el-option
            v-for="item in bankaddData.selectList"
            :key="item.id"
        ...
        <el-select
          v-model="bankaddData.selectList2"
          placeholder="请选择"
          class="ele-st"
        >
          <el-option
            v-for="item in bankaddData.selectListA"
            :key="item.id"
            :label="item.bank_name"
            :value="item.id"
          ></el-option>
      ...
      <el-form-item label="银行联系人" prop="bank_rersonnel_name">
        <el-input
          v-model="bankaddData.bank_rersonnel_name"
