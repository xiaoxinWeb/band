...
<template>
    ...
    <el-select placeholder="请选择职位" v-model="ruleForm.channel_position">
      <el-option label="业务员" value="1"></el-option>
      <el-option label="总账户 " value="2"></el-option>
    </el-select>
            </el-form-item>
            <el-form-item label="联系人电话" prop="channel_phone">
             <el-input v-model="ruleForm.channel_phone" placeholder="请输入联系人电话"></el-input>
            </el-form-item>
            <el-form-item label="渠道联系人" prop="channel_user_name">
             <el-input v-model="ruleForm.channel_user_name" placeholder="请输入渠道联系人"></el-input>
            </el-form-item>
            <!-- 上传图片 -->
 ...
 accept="image/png,image/gif,image/jpg,image/jpeg"
  >
 <el-image v-if="ruleForm.imageUrl" :src="ruleForm.imageUrl" class="avatar"></el-image>
        ...
        return{
            ...
            rules:{
                 channel_name:[
                   ...
                   channel_user_name:[
                        {
                    required: true, message: '渠道联系人不能为空', trigger: 'blur'
                     }
                   ],
                   channel_position:[
                        { required: true, message: '请选择员联系人职位', trigger: 'change' }
                   ],
                   imageUrl:[
                         {
